	...
	createRain() {
		...
		goutte.interval = setInterval(() => {
			...
			if (new_position.y <= -(cloudPositionY - 1)) {
				...
				// let position1 = goutte.getAttribute('position');
				// let position2 = goutte.getAttribute('position');
				// let position3 = goutte.getAttribute('position');
				// let position4 = goutte.getAttribute('position');
